...
#include "esp32_can_builtin.h"
                                                                        ...
                                                                        //tx,         rx,           mode
twai_general_config_t twai_general_cfg = TWAI_GENERAL_CONFIG_DEFAULT(GPIO_NUM_18, GPIO_NUM_19, TWAI_MODE_NORMAL);
...
void ESP32CAN::setDebuggingMode(bool enabled)
{
    debuggingMode = enabled;
}
